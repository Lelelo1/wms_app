...
import 'package:wms_app/models/image.dart';
...
class VisionService {
  ...
  Future<String> analyzeBarcode(AbstractImage abstractImage) async {
    var barcodes = await _barcodeDetector.detectInImage(
        GoogleVisionImage.fromBytes(
            abstractImage.concatenatedPlanes, abstractImage.imageMetaData));
